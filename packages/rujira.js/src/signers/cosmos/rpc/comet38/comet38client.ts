...
export class Comet38Client {
  ...
  public async abciQuery(
    ...
    return this.doCall(
      query,
      Params.encodeAbciQuery,
      Responses.decodeAbciQuery
    );
  }
  ...
  public async blockResults(
    ...
    return this.doCall(
      query,
      Params.encodeBlockResults,
      Responses.decodeBlockResults
    );
  }
  ...
  public async blockchain(
    ...
    return this.doCall(
      query,
      Params.encodeBlockchain,
      Responses.decodeBlockchain
    );
  }
  ...
  public async broadcastTxSync(
    ...
    return this.doCall(
      query,
      Params.encodeBroadcastTx,
      Responses.decodeBroadcastTxSync
    );
  }
  ...
  public async broadcastTxAsync(
    ...
    return this.doCall(
      query,
      Params.encodeBroadcastTx,
      Responses.decodeBroadcastTxAsync
    );
  }
  ...
  public async broadcastTxCommit(
    ...
    return this.doCall(
      query,
      Params.encodeBroadcastTx,
      Responses.decodeBroadcastTxCommit
    );
  }
  ...
  public async numUnconfirmedTxs(): Promise<responses.NumUnconfirmedTxsResponse> {
    ...
    return this.doCall(
      query,
      Params.encodeNumUnconfirmedTxs,
      Responses.decodeNumUnconfirmedTxs
    );
  }
